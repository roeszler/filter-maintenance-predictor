...
* The df_train set is already provided. With the data bins now evenly proportioned, it contains **XXXX** observations.

* Using the df_test as the source data, we split it into a proportion of bins closest to validation 40% and test 60%.
